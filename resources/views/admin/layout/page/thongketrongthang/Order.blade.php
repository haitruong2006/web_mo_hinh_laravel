    ...
    <div class="pcoded-inner-content">
        <div class="main-body">
            <div class="page-wrapper">
                <h1 style="text-align:center">Danh Sách Đơn Hàng Mới Trong Tháng</h1>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <?php $total_price+=$bill->total ?>
                        </form>

                        @endforeach
                        <tr>
                            <th colspan="6">Tổng số đơn</th>
                            <td>{{ $count_bill }}</td>
                        </tr>
                        <tr>
                            <th colspan="6">Tổng tiền thu được</th>
